                ...
                <div className="absolute bottom-4 left-4 right-4 flex justify-between items-end">
                  ...
                  <div className="flex gap-2">
                    {project.tags.map(tag => (
                      <span key={tag}
                            className="text-[10px] font-medium tracking-wide px-2 py-0.5 rounded backdrop-blur bg-black/60 text-white">
                        {tag}
                      </span>
                    ))}
                  </div>
              ...
              <div className="p-6 flex-1 flex flex-col justify-between">
                ...
                <div className="flex items-center gap-3 pt-4 border-t border-primary">
                  ...
                  <motion.a
                    ...
                    onClick={(e) => {
                      e.preventDefault();
                      alert("Interactive client prototype live inside AI Studio sandbox!");
                    }}
                    whileHover={{scale: 1.05}}
...
function QuoteIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
      ...
      <path
        d="M3 21c3 0 7-1 7-8V5c0-1.25-.75-2-2-2H4c-1.25 0-2 .75-2 2v4c0 1.25.75 2 2 2h4l-3 6a1 1 0 0 0 .5 1.5M14 21c3 0 7-1 7-8V5c0-1.25-.75-2-2-2h-4c-1.25 0-2 .75-2 2v4c0 1.25.75 2 2 2h4l-3 6a1 1 0 0 0 .5 1.5"/>
    </svg>
  );
}
