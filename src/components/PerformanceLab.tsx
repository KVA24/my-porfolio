...
const PerformanceLab = memo(function PerformanceLab() {
  ...
  return (
    <section id="performance-lab"
             className="py-20 px-4 sm:px-8 border-t transition-colors duration-200 bg-primary border-primary">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 animate-fade-in">
          <p
            className="font-bold uppercase tracking-widest text-xs flex items-center justify-center gap-2 text-secondary">
          ...
          <p className="text-sm mt-3 max-w-xl mx-auto text-secondary">
            Test how custom virtualization and state memoization affect real-time computation rendering pipelines.
            Toggle optimization to view raw milliseconds stats!
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div
            className="lg:col-span-4 flex flex-col justify-between glass-panel rounded-xl border p-6 lg:p-8 transition-colors bg-secondary border-primary">
            <div>
              ...
              <div className="space-y-4 pt-4 border-t border-secondary">
                <div className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer select-none">
                    ...
                    />
                    <div
                      className="w-11 h-6 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-emerald-500 bg-secondary after:bg-primary"></div>
                  </label>
                </div>
          ...
          <div
            className="lg:col-span-8 rounded-xl border p-6 lg:p-8 flex flex-col justify-between transition-colors bg-secondary border-primary">
            <div>
              <div
                className="flex flex-col sm:flex-row justify-between items-start sm:items-center pb-4 mb-6 border-b border-primary">
                <div>
                ...
                <div
                  className="text-xs font-mono mt-2 sm:mt-0 px-3 py-1 rounded border transition-colors bg-tertiary text-secondary border-primary">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                ...
                <div
                  className="p-5 rounded-lg border flex flex-col justify-between transition-colors bg-tertiary border-primary">
                ...
                {/* Benchmark Status */}
                <div
                  className="p-5 rounded-lg border relative overflow-hidden transition-colors bg-tertiary border-primary">
              ...
              <div className="space-y-2">
                ...
                <div
                  className="p-4 rounded-lg border h-32 overflow-y-auto grid grid-cols-10 sm:grid-cols-20 gap-1 select-none transition-colors bg-tertiary border-primary">
            ...
            <div className="mt-6 p-4 rounded border text-xs transition-colors alert-info">
              💡 <strong>How Khien Nguyen optimized this:</strong> By default, React re-evaluates all children elements.
              In large lists / real-time grids, deploying <code>React.memo</code>, combined
              with <code>useCallback</code> to avoid recreate reference addresses, prevents unneeded main thread
              calculations.
            </div>
          </div>
        </div>
