...
import {Activity, Sliders, Sparkles} from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        >
          <div className="relative group max-w-sm w-full">
            {/* Modern Framing */}
            <m.div
              className="absolute -inset-2 bg-linear-to-r from-cyan-500 to-emerald-400 rounded-2xl blur opacity-30 group-hover:opacity-50 transition duration-500"/>
            <m.div
            ...
            >
              ...
              >
                <div>
                  <p
                    className="text-[10px] uppercase font-bold tracking-wider text-secondary">{t('about.expertiseLabel')}</p>
        ...
        >
          ...
          <m.p variants={itemVariants} className="text-base leading-relaxed text-secondary">
            {t('about.description')}
          </m.p>
          ...
          >
            ...
            >
              <m.div
                className="h-10 w-10 rounded-lg flex items-center justify-center mb-4 border bg-cyan-950 text-accent border-cyan-800/30"
            ...
            >
              <m.div
                className="h-10 w-10 rounded-lg flex items-center justify-center mb-4 border bg-emerald-950 text-emerald-400 border-emerald-800/30"
                whileHover={{rotate: -12}}>
                <Sliders size={20}/>
              </m.div>
          ...
          >
            <p className="italic text-sm text-primary">
              &ldquo;Architecture isn&apos;t just about drawing lines in a spreadsheet; it&apos;s about shipping
              component rendering trees that run at 60 FPS on lower-tier mobile hardware.&rdquo;
            </p>
