    ...
    <section id="about" className="py-20 px-4 sm:px-8 border-t border-[#21262d] bg-[#0d1117] grid-bg">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-7 flex flex-col justify-center space-y-6">
          <div>
            <p className="text-xs font-bold text-cyan-400 uppercase tracking-widest">{t.aboutSubtitle}</p>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-white mt-1">{t.aboutTitle}</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4">
            <div className="p-5 rounded-xl border border-[#30363d] bg-[#161b22]/40 hover:bg-[#161b22]/80 transition-all hover:-translate-y-1">
              ...
              <h4 className="text-white font-bold text-base mb-2">{t.aboutCoreTechTitle}</h4>
              <p className="text-xs text-[#8b949e] leading-relaxed">{t.aboutCoreTechDesc}</p>
            </div>
            ...
            <div className="p-5 rounded-xl border border-[#30363d] bg-[#161b22]/40 hover:bg-[#161b22]/80 transition-all hover:-translate-y-1">
              ...
              <h4 className="text-white font-bold text-base mb-2">{t.aboutMindsetTitle}</h4>
              <p className="text-xs text-[#8b949e] leading-relaxed">{t.aboutMindsetDesc}</p>
            </div>
          </div>
