        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <p className="text-sm leading-relaxed max-w-sm text-secondary">
              Bạn có ý tưởng dự án hoặc cần nâng cấp hiệu năng ứng dụng React hiện tại? Hãy liên hệ ngay để cùng xây
              dựng giải pháp vượt trội.
            </p>
            
            <div className="space-y-4 pt-4">
              <div className="flex items-start gap-4">
                <div
                  className="h-10 w-10 rounded-lg border flex items-center justify-center flex-shrink-0 transition-colors badge-info">
                  <Mail size={18}/>
                </div>
                <div>
              ...
              <div className="flex items-start gap-4">
                <div
                  className="h-10 w-10 rounded-lg border flex items-center justify-center flex-shrink-0 transition-colors bg-secondary text-secondary border-secondary">
                  <Phone size={18}/>
                </div>
                <div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p
                    className="text-xs uppercase font-bold tracking-wider text-secondary">{t('contact.info.location')}</p>
              ...
              {localMessages.length === 0 ? (
                ...
                <div className="space-y-3 max-h-48 overflow-y-auto pr-1">
                  {localMessages.map((msg) => (
                    <div key={msg.id}
                         className="p-3 rounded-lg border flex justify-between items-start text-xs group transition-colors bg-tertiary border-primary">
