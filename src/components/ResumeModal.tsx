      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div
              className="p-6 sm:p-10 overflow-y-auto space-y-8 text-xs sm:text-sm bg-secondary leading-relaxed text-primary">
              
              {/* Header Profile Info inside CV */}
              <div
                className="border-b border-primary pb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                  <h2 className="text-3xl font-extrabold text-strong">Nguyễn Thành Khiên</h2>
                  <p className="text-accent font-mono font-bold text-sm tracking-wide mt-1">Lead React / Frontend
                    Engineer</p>
                ...
                <div
                  className="bg-tertiary border border-primary px-4 py-3 rounded-lg text-xs font-mono space-y-1 text-secondary">
              ...
              <div className="space-y-2">
                <h4
                  className="text-strong font-extrabold text-sm uppercase tracking-wide border-b border-primary pb-1 flex items-center gap-1.5">
                  <User size={14} className="text-accent"/>
                  <span>Executive Summary</span>
                </h4>
                <p className="text-primary leading-relaxed text-xs">
                  Software engineer with over 5 years of commercial experience in Javascript frameworks, actively
                  focusing on building high-performance large-scale corporate portals using React 18, NextJS, and robust
                  TypeScript micro-architectures. Obsessed with high Core Web Vitals optimization scores (LCP, FID) and
                  reliable custom state layers.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative border-l border-accent pl-4 space-y-2">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center text-xs">
                      <div>
                        ...
                        <span
                          className="text-accent block sm:inline sm:ml-2 font-semibold">@ TechCorp Vietnam LLC</span>
                      </div>
                    ...
                    <p className="text-secondary font-medium text-xs">
                      Architect and maintain multi-tier financial SaaS analytics panels, leading a team of 4 senior
                      developers.
                    </p>
                    <ul className="list-disc pr-4 pl-4 space-y-1 text-secondary mt-1 text-[11px]">
                      <li>Refactored obsolete React workflows, decreasing initial page weight bundles by 35% using lazy
                        chunks splitting.
                      </li>
                      <li>Introduced shared micro-frontend libraries, saving up to 80 development hours on nested admin
                        tooling cycles.
                      </li>
                  ...
                  <div className="relative border-l border-primary pl-4 space-y-2">
                    ...
                    <ul className="list-disc pr-4 pl-4 space-y-1 text-secondary mt-1 text-[11px]">
                      <li>Collaborated with overseas UX designers to craft high-fidelity animation transitions using
                        Framer Motion.
                      </li>
                      <li>Secured checkout workflows with custom stripe middleware hooks, maintaining zero leakage rate
                        logs.
                      </li>
                    </ul>
                  </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <span
                      className="text-secondary block text-xs"> Hanoi University of Science &amp; Technology (HUST)</span>
                    <span
                      className="text-muted font-mono text-[10px]">GPA 3.6 / Graduated with High Honors (2017-2021)</span>
                  </div>
                </div>
